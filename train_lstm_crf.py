...
tf.flags.DEFINE_string("tag2label_file", "./data/resume_ner/tag2label.txt", "tag2label dic.")
...
tf.flags.DEFINE_float("learning_rate", 5e-4, "Learning rate (default: 0.001)")
...
checkpoint_out_dir = os.path.join("D:/Expriment/model_output/ner_tool/lstm_crf/single_task/resume_ner/runs/", timestamp)
